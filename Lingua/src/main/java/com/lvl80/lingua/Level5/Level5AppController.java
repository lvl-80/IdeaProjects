...
public class Level5AppController {
    @FXML
    ...
    public void checkLevel5Test() throws IOException {
        // проверка правильности теста
        if (tf1.getText().equals("int") && tf2.getText().equals("try") && tf3.getText().equals("/")
                && tf4.getText().equals("throws") && tf5.getText().equals("if") && tf6.getText().equals("0")
                && tf7.getText().equals("new") && tf8.getText().equals("2") && tf9.getText().equals("15")
                && tf10.getText().equals("12")
                && !rb1.isSelected() && !rb2.isSelected() && rb3.isSelected() && rb4.isSelected())
        {
            ...
            // если уровень соответствует 5, то повышаем до 6
            if (user.getLevel() == 5) {
